...
urgent_response_examples = [
    ...
    {
        "name": "Human requires Beef",
        "Situation": "The kitchen currently has two pending orders for LettuceBurgers and two for BeefBurgers. The human player has sent a message saying, 'We need Beef.'",
        "Current Assigned Tasks": [],
        "Current Behavior Pattern": {},
        "Reflection on History & Description of Agent Behavior Modifications": "Given the human player's message, it is crucial to prioritize preparing beef. The agent must adjust the assigned Tasks to include preparing beef to ensure that BeefBurgers can be completed efficiently.",
        "New Assigned Tasks": [
            (
                "lambda json_state: json_state['objects'][('Beef', 'Well-cooked')] + json_state['objects'][('Beef', 'In-progress')] < 2",
                ("prepare", {"food": "Beef"}),
            ),
            (
                "lambda json_state: json_state['objects'][('Beef', 'Well-cooked')] + json_state['objects'][('Beef', 'In-progress')] < 2",
    ...
    {
        "name": "Unnecessary Lettuce Requirement",
        "Situation": "The kitchen currently has two pending orders for LettuceBurgers and two for BeefBurgers, and there are two Chopped Lettuce and two Well-cooked Beef. The human player sends a message saying, 'We need Lettuce'",
        "Current Assigned Tasks": [],
        "Current Behavior Pattern": {},
        "Reflection on History & Description of Agent Behavior Modifications": "Given the human player's request to prepare more lettuce, despite already having enough, the agent must carefully balance the need to acknowledge the human player's input while maintaining efficient workflow. The agent should avoid unnecessary actions and focus on completing the current orders. No changes will be made, as the kitchen's needs are already satisfied",
        "New Assigned Tasks": [],
        "New Behavior Pattern": {},
    },
    {
