        ...
        return new Promise(function(resolve, reject) {
            resolve(function(state, done, lstm_state, game) {
                ...
                if (model.inputs.length == 1) {
                    ...
                    action_tensor = model.execute({
                        "ppo_agent/ppo2_model/Ob": state_tensor
                    });
                    ...
                    let [out_lstm_state_tensor, action_tensor] = model.execute({
                        "ppo_agent/ppo2_model/Ob": state_tensor,
                        "ppo_agent/ppo2_model/pi/lstm_state": in_lstm_state_tensor,
                        "ppo_agent/ppo2_model/pi/lstm_mask": dones_tensor
                    });
                    action_probs = action_tensor.arraySync()[0];
